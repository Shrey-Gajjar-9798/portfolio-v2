...
const Card: React.FC<CardProps> = ({i, title, description, src, url, color, progress, range, targetScale}) => {
  ...
  return (
    <div ref={container} className="h-screen pt-[30vh] flex items-center justify-center sticky top-0">
      <motion.div 
        style={{
      ...
      >
        ...
        <div className="flex h-full mt-[50px] gap-[50px]">
          <div className="w-[40%] relative top-[10%]">
            <p className="text-base first-letter:text-[28px]">{description}</p>
            <span className="flex items-center gap-[5px]">
              <a href={url} target="_blank" rel="noopener noreferrer" className="text-xs underline cursor-pointer">
                See more
              </a>
