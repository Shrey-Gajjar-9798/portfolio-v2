...
import { Shield, Network, Blocks, PersonStanding, Fuel, Server } from "lucide-react"
import Card from "../ui/SpotlightCard"
...
export function FeaturesSection() {
    const features = [
        ...
        },
        {
            icon: Server,
            title: "DeFi & DePIN Development",
            description: "Proven experience in handling 10,000+ active users using AWS, Docker, PM2, and CI/CD pipelines.",
            gradient: "from-chart-3/20 to-primary/20",
            iconColor: "text-chart-3",
        },
        {
            icon: Fuel,
            title: "Gas-optimized smart contracts",
            description: "Focus on writing highly efficient smart contracts. Proven results in reducing costs and improving transaction speed.",
            gradient: "from-chart-3/20 to-primary/20",
            iconColor: "text-chart-3",
        },
    ]
        ...
        <section className="w-full py-20 px-4 md:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16 space-y-4">
                    <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-balance">My Blockchain Expertise</h2>
